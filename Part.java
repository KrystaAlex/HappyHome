...
public abstract class Part implements Serializable {
    ...
    //@ValidMin(message = "Minimum inventory error.")
    //@Min(0)
    private int minInv;
   // @Max(value = 1000, message = "Inventory value must be below the set maximum")
   //@ValidMax(message = "Maximum inventory count is exceeded!")
   public int maxInv;
